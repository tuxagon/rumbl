defmodule Rumbl.VideoControllerTest do
  ...
  @tag login_as: "max"
  test "lists all the user's videos on index", %{conn: conn, user: user} do
  ...
  @tag login_as: "max"
  test "does not create vieo and renders errors when invalid", %{conn: conn} do
